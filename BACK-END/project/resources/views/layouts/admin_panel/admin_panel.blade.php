...
{{--            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{route('categories.index')}}">Категории</a>--}}
            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{route('admin.users.index')}}">Пользователи</a>
            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{route('admin.products.index')}}">Продукты</a>
            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{route('admin.orders.index')}}">Заказы</a>
            <a class="list-group-item list-group-item-action list-group-item-light p-3" href="{{route('admin.order-products.index')}}">Товары закзов</a>
        </div>
    </div>
